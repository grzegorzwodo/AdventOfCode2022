...
public class Task2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (scanner.hasNextLine()) {
            ...
            RPSEnum my = getRPSEnumByResultSymbol(symbol2, opponent);
    ...
    static RPSEnum getRPSEnumByResultSymbol(String resultSymbol, RPSEnum opponent) throws IOException {
        Result result = Arrays.stream(Result.values()).filter(r -> r.getSymbol().equals(resultSymbol)).findFirst().get();
        ...
        throw new IOException("Error in logic: " + opponent + " -> " + resultSymbol);
    }
