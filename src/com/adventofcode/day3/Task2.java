...
public class Task2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (scanner.hasNextLine()) {
            ...
            duplicates.add(findDuplicateLetter(line1, line2, line3));
        }
    ...
    private static String findDuplicateLetter(String part1, String part2, String part3) {
        for (int i = 0; i < part1.length(); i++) {
            if (part2.contains(part1.charAt(i) + "") && part3.contains(part1.charAt(i) + "")) {
